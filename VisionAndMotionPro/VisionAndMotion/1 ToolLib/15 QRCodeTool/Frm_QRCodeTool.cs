...
{
    public partial class Frm_QRCodeTool : Frm_ToolBase
    {
        public Frm_QRCodeTool()
        {
            InitializeComponent();
        }
        ...
        /// 窗体对象实例
        /// </summary>
        private static Frm_QRCodeTool _instance;
        public static Frm_QRCodeTool Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new Frm_QRCodeTool();
                return _instance;
            }
        }
        /// <summary>
