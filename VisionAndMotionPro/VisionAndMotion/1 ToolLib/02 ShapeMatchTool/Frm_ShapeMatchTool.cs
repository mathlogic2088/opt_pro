...
{
    internal partial class Frm_ShapeMatchTool : Frm_ToolBase
    {
        ...
        public static Frm_ShapeMatchTool Instance
        {
            get
            {
                if (_instance == null)
        ...
        /// 当前工具所对应的工具对象
        /// </summary>
        internal static ShapeMatchTool shapeMatchTool = new ShapeMatchTool();
