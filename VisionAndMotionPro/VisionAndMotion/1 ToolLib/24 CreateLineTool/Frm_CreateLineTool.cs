...
{
    internal partial class Frm_CreateLineTool : Frm_ToolBase
    {
        internal Frm_CreateLineTool()
        {
            InitializeComponent();
        }
        ...
        /// 窗体对象实例
        /// </summary>
        private static Frm_CreateLineTool _instance;
        public static Frm_CreateLineTool Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new Frm_CreateLineTool();
                return _instance;
            }
        }
        /// <summary>
        ...
        private void Frm_CreateLineTool_Load(object sender, EventArgs e)
        {
