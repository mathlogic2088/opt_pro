...
{
    [Serializable]
    class SDK_MindVisionTool : ToolBase
    {
        /// <summary>
        /// 曝光时间
        /// </summary>
        ...
        internal void Select_Image_Path()
        {
            try
            {
                ...
                {
                    Frm_ReadFromLocal.Instance.tbx_imagePath.Text = dig_openImage.FileName;
        ...
        internal void Select_Image_Directory()
        {
            try
            {
                ...
                if (folderBrowseDialog.ShowDialog() == System.Windows.Forms.DialogResult.OK)
                {
                    ...
                    Frm_ReadFromLocalMindVision.Instance.tbx_imageDirectory.Text = folderBrowseDialog.SelectedPath;
                    ...
                    if (L_imageFile.Count > 0)
                    {
                        ...
                        Frm_ReadFromLocalMindVision.Instance.lbl_imageName.Text = currentImageName;
                    }
        ...
        internal void Read_Last_Image()
        {
            try
            {
                ...
                Frm_ReadFromLocalMindVision.Instance.lbl_imageName.Text = currentImageName;
                Frm_ReadFromLocalMindVision.Instance.lbl_imageNum.Text = "共" + L_imageFile.Count + "张";
            }
            catch (Exception ex)
            {
               LogHelper.SaveErrorInfo(ex);
        ...
        internal void Real_Time_Acquistion()
        {
            try
            {
                ...
                {
                    Frm_SDK_MindVisionTool.Instance.tsb_realTimeDisplay.CheckState = CheckState.Unchecked;
                ...
                {
                    realTimeMode = true;
                    Frm_SDK_MindVisionTool.Instance.tsb_realTimeDisplay.CheckState = CheckState.Checked;
                    Frm_AcqFromDeviceMindVision.Instance.btn_RealTime.Text = "停止实时";
                    Frm_AcqFromDeviceMindVision.Instance.btn_runMindVisionTool.Enabled = false;
                    Frm_AcqFromDeviceMindVision.Instance.btn_saveImage.Enabled = false;
                    Frm_AcqFromDeviceMindVision.Instance.cbx_deviceList.Enabled = false;
                    Frm_AcqFromDeviceMindVision.Instance.btn_registdImage.Enabled = false;
                    Frm_AcqFromDeviceMindVision.Instance.tbx_exposure.Enabled = false;
                    Frm_AcqFromDeviceMindVision.Instance.btn_runMindVisionTool.BackColor = Color.LightGray;
                    Frm_AcqFromDeviceMindVision.Instance.btn_saveImage.BackColor = Color.LightGray;
                    Frm_AcqFromDeviceMindVision.Instance.btn_registdImage.BackColor = Color.LightGray;
                }
                else
                {
                    realTimeMode = false;
                    Frm_SDK_MindVisionTool.Instance.tsb_realTimeDisplay.CheckState = CheckState.Unchecked;
                    Frm_AcqFromDeviceMindVision.Instance.btn_RealTime.Text = "实时采集";
                    Frm_AcqFromDeviceMindVision.Instance.btn_runMindVisionTool.Enabled = true;
                    Frm_AcqFromDeviceMindVision.Instance.btn_saveImage.Enabled = true;
                    Frm_AcqFromDeviceMindVision.Instance.btn_registdImage.Enabled = true;
                    Frm_AcqFromDeviceMindVision.Instance.cbx_deviceList.Enabled = true;
                    Frm_AcqFromDeviceMindVision.Instance.btn_runMindVisionTool.BackColor = Color.White;
                    Frm_AcqFromDeviceMindVision.Instance.btn_saveImage.BackColor = Color.White;
                    Frm_AcqFromDeviceMindVision.Instance.btn_registdImage.BackColor = Color.White;
                    Frm_AcqFromDeviceMindVision.Instance.tbx_exposure.Enabled = true;
                }
        ...
        internal void Device_Changed(string deviceDescriptionStr)
        {
            try
            {
                if (Frm_AcqFromDeviceMindVision.Instance.cbx_deviceList.Text != "")
                {
                    for (int i = 0; i < Camera_Basler.L_devices.Count; i++)
                    {
                        if (Camera_Basler.L_devices[i].DeviceInfoStr == deviceDescriptionStr)
                        {
                            Frm_AcqFromDeviceMindVision.Instance.tkb_exposure.Maximum = Camera_Basler.L_devices[i].MaxExposure;
                            Frm_AcqFromDeviceMindVision.Instance.tkb_exposure.Minimum = Camera_Basler.L_devices[i].MinExposure;
                            ...
                            Frm_AcqFromDeviceMindVision.Instance.tbx_exposure.Text = exposure.ToString();
                            Frm_AcqFromDeviceMindVision.Instance.tkb_exposure.Value = exposure;
                            Frm_AcqFromDeviceMindVision.Instance.lbl_exposureRange.Text = "曝光范围：" + Camera.L_device[i].MinExposure + " ~ " + Camera.L_device[i].MaxExposure;
        ...
        internal void Set_Exposure(string jobName)
        {
            try
            {
                ...
                if (Camera_basler != null)
                {
                    Int32 exposure = Convert.ToInt32(Frm_AcqFromDeviceMindVision.Instance.tbx_exposure.Text.Trim());
                    for (int i = 0; i < Camera.L_device.Count; i++)
                    {
                        if (Camera.L_device[i].DeviceDescriptionStr == Frm_AcqFromDeviceMindVision.Instance.cbx_deviceList.Text.Trim())
                        {
                    ...
                    if (Frm_AcqFromDeviceMindVision.Instance.tkb_exposure.Value != exposure)
                        Frm_AcqFromDeviceMindVision.Instance.tkb_exposure.Value = exposure;
            ...
            else
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        //if (autoSwitch && Frm_Main.Instance.btm_autoSwitch.Checked == false)
                        //{
                        //    currentImageIndex = currentImageIndex + 1;
                        //}
                        if (currentImageIndex > L_imageFile.Count - 1)
