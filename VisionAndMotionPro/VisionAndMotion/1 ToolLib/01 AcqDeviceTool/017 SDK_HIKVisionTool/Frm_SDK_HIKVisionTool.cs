...
{
    public partial class Frm_SDK_HIKVisionTool : Frm_ToolBase
    {
        public Frm_SDK_HIKVisionTool()
        {
            InitializeComponent();
        }
        ...
        /// 窗体对象实例
        /// </summary>
        private static Frm_SDK_HIKVisionTool _instance;
        public static Frm_SDK_HIKVisionTool Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new Frm_SDK_HIKVisionTool();
                return _instance;
            }
        }
        ...
        {
            SDK_hikVisionTool.Work_Mode_Changed(sender);
        }
        ...
        private void ckb_imageAcquistionToolEnable_CheckedChanged(object sender, EventArgs e)
        {
            if (Frm_Main.ignore)
                return;
            Job.GetToolInfoByToolName(jobName, toolName).enable = ckb_HIKVisionToolEnable.Checked;
        }

        private void tsb_runTool_Click(object sender, EventArgs e)
        {
            SDK_hikVisionTool.Run( jobName,true ,false );
