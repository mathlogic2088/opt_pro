...
{
    [Serializable]
    class SDK_IMAVisionTool : ToolBase
    {
        /// <summary>
        /// 曝光时间
        /// </summary>
        ...
        internal void Work_Mode_Changed(object sender)
        {
            if (((Button)sender).Text == "设  备  采  集")
            {
                ...
                Frm_AcqFromDeviceCognex.Instance.Parent = Frm_SDK_IMAVisionTool.Instance.pnl_formBox;
            ...
            else
            {
                ...
                Frm_ReadFromLocalCognex.Instance.Parent = Frm_SDK_IMAVisionTool.Instance.pnl_formBox;
        ...
        internal void Real_Time_Acquistion()
        {
            try
            {
                ...
                {
                    Frm_SDK_IMAVisionTool.Instance.tsb_realTimeDisplay.CheckState = CheckState.Unchecked;
                ...
                {
                    realTimeMode = true;
                    Frm_SDK_IMAVisionTool.Instance.tsb_realTimeDisplay.CheckState = CheckState.Checked;
                    Frm_AcqFromDeviceIMAVision.Instance.btn_RealTime.Text = "停止实时";
                    Frm_AcqFromDeviceIMAVision.Instance.btn_runIMAVisionTool.Enabled = false;
                    Frm_AcqFromDeviceIMAVision.Instance.btn_saveImage.Enabled = false;
                    Frm_AcqFromDeviceIMAVision.Instance.cbx_deviceList.Enabled = false;
                    Frm_AcqFromDeviceIMAVision.Instance.btn_registImage.Enabled = false;
                    Frm_AcqFromDeviceIMAVision.Instance.tbx_exposure.Enabled = false;
                    Frm_AcqFromDeviceIMAVision.Instance.btn_runIMAVisionTool.BackColor = Color.LightGray;
                    Frm_AcqFromDeviceIMAVision.Instance.btn_saveImage.BackColor = Color.LightGray;
                    Frm_AcqFromDeviceIMAVision.Instance.btn_registImage.BackColor = Color.LightGray;
                }
                else
                {
                    realTimeMode = false;
                    Frm_SDK_IMAVisionTool.Instance.tsb_realTimeDisplay.CheckState = CheckState.Unchecked;
                    Frm_AcqFromDeviceIMAVision.Instance.btn_RealTime.Text = "实时采集";
                    Frm_AcqFromDeviceIMAVision.Instance.btn_runIMAVisionTool.Enabled = true;
                    Frm_AcqFromDeviceIMAVision.Instance.btn_saveImage.Enabled = true;
                    Frm_AcqFromDeviceIMAVision.Instance.btn_registImage.Enabled = true;
                    Frm_AcqFromDeviceIMAVision.Instance.cbx_deviceList.Enabled = true;
                    Frm_AcqFromDeviceIMAVision.Instance.btn_runIMAVisionTool.BackColor = Color.White;
                    Frm_AcqFromDeviceIMAVision.Instance.btn_saveImage.BackColor = Color.White;
                    Frm_AcqFromDeviceIMAVision.Instance.btn_registImage.BackColor = Color.White;
                    Frm_AcqFromDeviceIMAVision.Instance.tbx_exposure.Enabled = true;
                }
        ...
        internal void Device_Changed(string deviceDescriptionStr)
        {
            try
            {
                if (Frm_AcqFromDeviceBasler.Instance.cbx_deviceList.Text != "")
                {
                    for (int i = 0; i < Camera_Basler.L_devices.Count; i++)
                    {
                        if (Camera_Basler.L_devices[i].DeviceInfoStr == deviceDescriptionStr)
                        {
                            Frm_AcqFromDeviceIMAVision.Instance.tkb_exposure.Maximum = Camera_Basler.L_devices[i].MaxExposure;
                            Frm_AcqFromDeviceIMAVision.Instance.tkb_exposure.Minimum = Camera_Basler.L_devices[i].MinExposure;
                            ...
                            Frm_AcqFromDeviceIMAVision.Instance.tbx_exposure.Text = exposure.ToString();
                            Frm_AcqFromDeviceIMAVision.Instance.tkb_exposure.Value = exposure;
                            Frm_AcqFromDeviceIMAVision.Instance.lbl_exposureRange.Text = "曝光范围：" + Camera.L_device[i].MinExposure + " ~ " + Camera.L_device[i].MaxExposure;
        ...
        internal void Set_Exposure(string jobName)
        {
            try
            {
                ...
                if (Camera_basler != null)
                {
                    Int32 exposure = Convert.ToInt32(Frm_AcqFromDeviceIMAVision.Instance.tbx_exposure.Text.Trim());
                    for (int i = 0; i < Camera.L_device.Count; i++)
                    {
                        if (Camera.L_device[i].DeviceDescriptionStr == Frm_AcqFromDeviceIMAVision.Instance.cbx_deviceList.Text.Trim())
                        {
                    ...
                    if (Frm_AcqFromDeviceIMAVision.Instance.tkb_exposure.Value != exposure)
                        Frm_AcqFromDeviceIMAVision.Instance.tkb_exposure.Value = exposure;
