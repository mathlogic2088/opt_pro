...
{
    public partial class Frm_SDK_IMAVisionTool : Frm_ToolBase 
    {
        public Frm_SDK_IMAVisionTool()
        {
            InitializeComponent();
        }
        ...
        /// 窗体对象实例
        /// </summary>
        private static Frm_SDK_IMAVisionTool _instance;
        public static Frm_SDK_IMAVisionTool Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new Frm_SDK_IMAVisionTool();
                return _instance;
            }
        }
        /// <summary>
        ...
        private void Image_Source_Mode_Changed(object sender)
        {
            if (((Button)sender).Text == "设  备  采  集")
            {
                ...
                SDK_imaVisionTool.imageSourceMode = ImageSourceMode.FormDevice;
            }
            else
            {
                ...
                SDK_imaVisionTool.imageSourceMode = ImageSourceMode.FromLocal;
            }
        }
        ...
        {
            Frm_AcqFromDeviceIMAVision.Instance.cbx_deviceList.Text = string.Empty;
            Frm_AcqFromDeviceIMAVision.Instance.tbx_exposure.Text = "0";
            Frm_AcqFromDeviceIMAVision.Instance.lbl_exposureRange.Text = "0 ~ 0";
            Frm_ReadFromLocalIMAVision.Instance.tbx_imageDirectory.Text = string.Empty;
            Frm_ReadFromLocalIMAVision.Instance.tbx_imagePath.Text = string.Empty;
            Frm_ReadFromLocalIMAVision.Instance.lbl_imageName.Text = string.Empty;
            Frm_ReadFromLocalIMAVision.Instance.lbl_imageNum.Text = "共0张";
            SDK_imaVisionTool.Reset_Tool();         
        }
        ...
        private void ckb_SDKIMAVisionToolEnable_CheckedChanged(object sender, EventArgs e)
        {
            if (Frm_Main.ignore)
                return;
            Job.GetToolInfoByToolName(jobName, toolName).enable = ckb_SDKIMAVisionToolEnable.Checked;
        }
