...
{
    internal partial class Frm_RegionOperationTool : Frm_ToolBase
    {
        internal Frm_RegionOperationTool()
        {
            InitializeComponent();
        }
        ...
        /// 窗体对象实例
        /// </summary>
        private static Frm_RegionOperationTool _instance;
        public static Frm_RegionOperationTool Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new Frm_RegionOperationTool();
                return _instance;
            }
        }
        /// <summary>
        /// 当前工具所对应的工具对象
        /// </summary>
        internal static RegionFeatureTool regionFeatureTool = new RegionFeatureTool();
