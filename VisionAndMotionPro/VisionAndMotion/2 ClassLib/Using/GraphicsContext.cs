...
namespace VisionAndMotion
{
	internal delegate void GCDelegate(string val);
	/// <summary>
    ...
    internal class GraphicsContext
	{
		...
		/// </summary>
		internal	Hashtable		stateOfSettings;
		...
		/// </summary>
		internal GCDelegate   gcNotification;
		...
		/// </param>
		internal GraphicsContext(Hashtable settings)
		{
		...
		/// </param>
		internal void applyContext(HWindow window, Hashtable cContext)
		{
			string key  = "";
			string valS = "";
			int    valI = -1;
		...
		/// </param>
		internal void setColorAttribute(string val)
		{
		...
		/// or "colored12" 
		/// </param>
		internal void setColoredAttribute(int val)
		{
		...
		/// </param>
		internal void setDrawModeAttribute(string val)
		{
		...
		/// </param>
		internal void setLineWidthAttribute(int val)
		{
		...
		/// </param>
		internal void setLutAttribute(string val)
		{
			addValue(GC_LUT, val);
		}
		...
		/// </param>
		internal void setPaintAttribute(string val)
		{
		...
		/// </param>
		internal void setShapeAttribute(string val)
		{
		...
		/// set_line_style.
		/// </param>
		internal void setLineStyleAttribute(HTuple val)
		{
		...
		/// </param>
		internal object getGraphicsAttribute(string key)
		{
			if (graphicalSettings.ContainsKey(key))
		...
		internal Hashtable copyContextList()
		{
			return (Hashtable)graphicalSettings.Clone();
		}

		/********************************************************************/
		internal void dummy(string val) { }
	}
}
