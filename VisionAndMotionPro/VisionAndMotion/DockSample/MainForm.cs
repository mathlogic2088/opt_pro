...
namespace DockSample
{
    public partial class MainForm : Form
    {
        ...
        private void menuItemLayoutByCode_Click(object sender, System.EventArgs e)
        {
            ...
            DummyDoc doc1 = CreateNewDocument("文档1[设计]");
            DummyDoc doc2 = CreateNewDocument("文档2[设计]");
            DummyDoc doc3 = CreateNewDocument("文档3[设计]");
            DummyDoc doc4 = CreateNewDocument("文档4[设计]");
